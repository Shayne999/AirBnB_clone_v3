...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        newState = State(name="Madeup State")
        newState.save()
        newUser = User(email="madeup@mail.com", password="password")
        newUser.save()
    ...
    def test_count(self):
        ...
        newState = State(name="Somewhere")
        newState.save()
        newUser = User(email="someone@gmail.com", password="mypassword")
        newUser.save()
